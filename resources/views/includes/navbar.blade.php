<nav class="navbar navbar-marketing navbar-expand-lg bg-transparent navbar-dark fixed-top">
  <div class="container">
      <a class="navbar-brand text-white" href="index.html">Bake Blog</a><button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          href="{{url('login')}}">Login<i class="fas fa-arrow-right ml-1"></i>
          </a>
          @endguest 
          @auth
          <form action="{{url('logout')}}" method="POST" class="form-inline">
            @csrf
            <button type="submit" class="btn-teal btn rounded-pill px-4 ml-lg-4">
              <i class="fas fa-arrow-right ml-1"></i> Logout
          </button>
          </form>
          @endauth
